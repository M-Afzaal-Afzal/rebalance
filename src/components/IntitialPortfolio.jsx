  ...
  return (
    <Box component="div" className="main">
      <div className="content">
        ...
        <Box
          component="div"
          className="tablewithhead"
          sx={save ? { display: "block" } : { display: "none" }}
        >
        ...
        >
          ...
          <Box
            className="ESG"
            sx={save ? { mt: 5, display: "block" } : { display: "none" }}
          >
            <h2>ESG performance</h2>
...
export default IntitialPortfolio;
